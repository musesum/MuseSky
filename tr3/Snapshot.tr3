sky {
    ...
    shader {
        ...
        cellZhabatinski { type:"compute"  file:"cell.zhabatinski.metal"  on:(0...1=0)
            buffer { version:(0...1=0)  bits:(2...4=3)  } repeat:11  }
...
panel {
    _cell {
        ...
        controls {
            ...
            ruleOn { type:"panelon"  title:"Active"  frame:(x:252 y:6 w:48 h:32)  icon:"icon.ring.white.png"  value:(0...1=0)  -> panel.cell˚ruleOn.value:0  -> panel.cell.speed.restart  lag:0  }
    ...
    cell {
        fader {
            ...
            controls {
                hide { type:"panelx"  title:"hide"  frame:(x:0 y:0 w:40 h:40)  icon:"icon.thumb.X.png"  value:(0...1=0)  }
                ruleOn { type:"panelon"  title:"Active"  frame:(x:252 y:6 w:48 h:32)  icon:"icon.cell.fader.png"  value:(0...1=0)  -> panel.cell˚ruleOn.value:0  -> panel.cell.speed.restart  -> sky.shader.cellFader.on  lag:0  }
                ...
                fillZero { type:"trigger"  title:"Fill Zero"  frame:(x:10 y:96 w:44 h:44)  icon:"icon.drop.clear.png"  value:(0...1=0)  -> sky.draw.screen.fillZero  }
                bitplane { type:"slider"  title:"Bit Plane"  frame:(x:64 y:96 w:192 h:44)  icon:"icon.pearl.white.png"  value:(0...1=0.2)  -> sky.shader.colorize.buffer.bitplane  }
                fillOne { type:"trigger"  title:"Fill Ones"  frame:(x:266 y:96 w:44 h:44)  icon:"icon.drop.gray.png"  value:(0...1=0)  -> sky.draw.screen.fillOne  } } }
        average {
            base { type:"cell"  title:"Average"  frame:(x:0 y:0 w:320 h:152)  icon:"icon.cell.average.png"  }
            controls {
                hide { type:"panelx"  title:"hide"  frame:(x:0 y:0 w:40 h:40)  icon:"icon.thumb.X.png"  value:(0...1=0)  }
                ruleOn { type:"panelon"  title:"Active"  frame:(x:252 y:6 w:48 h:32)  icon:"icon.cell.average.png"  value:(0...1=0)  -> panel.cell˚ruleOn.value:0  -> panel.cell.speed.restart  -> sky.shader.cellAverage.on  lag:0  }
                version { type:"segment"  title:"Version"  frame:(x:70 y:40 w:192 h:44)  value:(0...1=0.4)  -> sky.shader.cellAverage.buffer.version  user -> ruleOn.value:1  }
                fillZero { type:"trigger"  title:"Fill Zero"  frame:(x:10 y:96 w:44 h:44)  icon:"icon.drop.clear.png"  value:(0...1=0)  -> sky.draw.screen.fillZero  }
                bitplane { type:"slider"  title:"Bit Plane"  frame:(x:64 y:96 w:192 h:44)  icon:"icon.pearl.white.png"  value:(0...1=0)  -> sky.shader.colorize.buffer.bitplane  }
                fillOne { type:"trigger"  title:"Fill Ones"  frame:(x:266 y:96 w:44 h:44)  icon:"icon.drop.gray.png"  value:(0...1=0)  -> sky.draw.screen.fillOne  } } }
        melt {
            ...
            controls {
                hide { type:"panelx"  title:"hide"  frame:(x:0 y:0 w:40 h:40)  icon:"icon.thumb.X.png"  value:(0...1=0)  }
                ruleOn { type:"panelon"  title:"Active"  frame:(x:252 y:6 w:48 h:32)  icon:"icon.cell.melt.png"  value:(0...1=0)  -> panel.cell˚ruleOn.value:0  -> panel.cell.speed.restart  -> sky.shader.cellMelt.on  lag:0  }
        ...
        timetunnel {
            ...
            controls {
                hide { type:"panelx"  title:"hide"  frame:(x:0 y:0 w:40 h:40)  icon:"icon.thumb.X.png"  value:(0...1=0)  }
                ruleOn { type:"panelon"  title:"Active"  frame:(x:252 y:6 w:48 h:32)  icon:"icon.cell.timeTunnel.png"  value:(0...1=0)  -> panel.cell˚ruleOn.value:0  -> panel.cell.speed.restart  -> sky.shader.cellTimetunnel.on  lag:0  }
        ...
        zhabatinski {
            ...
            controls {
                hide { type:"panelx"  title:"hide"  frame:(x:0 y:0 w:40 h:40)  icon:"icon.thumb.X.png"  value:(0...1=0)  }
                ruleOn { type:"panelon"  title:"Active"  frame:(x:252 y:6 w:48 h:32)  icon:"icon.cell.zhabatinski.png"  value:(0...1=0)  -> panel.cell˚ruleOn.value:0  -> panel.cell.speed.restart  -> sky.shader.cellZhabatinski.on  lag:0  }
                version { type:"segment"  title:"Version"  frame:(x:70 y:40 w:192 h:44)  value:(0...1=0.75)  -> sky.shader.cellZhabatinski.buffer.version  user -> ruleOn.value:1  }
                fillZero { type:"trigger"  title:"Fill Zero"  frame:(x:10 y:96 w:44 h:44)  icon:"icon.drop.clear.png"  value:(0...1=0)  -> sky.draw.screen.fillZero  }
                bitplane { type:"slider"  title:"Bit Plane"  frame:(x:64 y:96 w:192 h:44)  icon:"icon.pearl.white.png"  value:(0...1=0)  -> sky.shader.colorize.buffer.bitplane  }
                fillOne { type:"trigger"  title:"Fill Ones"  frame:(x:266 y:96 w:44 h:44)  icon:"icon.drop.gray.png"  value:(0...1=0)  -> sky.draw.screen.fillOne  } } }
        slide {
            ...
            controls {
                hide { type:"panelx"  title:"hide"  frame:(x:0 y:0 w:40 h:40)  icon:"icon.thumb.X.png"  value:(0...1=0)  }
                ruleOn { type:"panelon"  title:"Active"  frame:(x:252 y:6 w:48 h:32)  icon:"icon.cell.slide.png"  value:(0...1=0)  -> panel.cell˚ruleOn.value:0  -> panel.cell.speed.restart  -> sky.shader.cellSlide.on  lag:0  }
        ...
        fredkin {
            ...
            controls {
                hide { type:"panelx"  title:"hide"  frame:(x:0 y:0 w:40 h:40)  icon:"icon.thumb.X.png"  value:(0...1=0)  }
                ruleOn { type:"panelon"  title:"Active"  frame:(x:252 y:6 w:48 h:32)  icon:"icon.cell.fredkin.png"  value:(0...1=0)  -> panel.cell˚ruleOn.value:0  -> panel.cell.speed.restart  -> sky.shader.cellFredkin.on  lag:0  }
                version { type:"segment"  title:"Version"  frame:(x:70 y:40 w:192 h:44)  value:(0...1=0.5)  -> sky.shader.cellFredkin.buffer.version  user -> ruleOn.value:1  }
                fillZero { type:"trigger"  title:"Fill Zero"  frame:(x:10 y:96 w:44 h:44)  icon:"icon.drop.clear.png"  value:(0...1=0)  -> sky.draw.screen.fillZero  }
                bitplane { type:"slider"  title:"Bit Plane"  frame:(x:64 y:96 w:192 h:44)  icon:"icon.pearl.white.png"  value:(0...1=0)  -> sky.shader.colorize.buffer.bitplane  }
                fillOne { type:"trigger"  title:"Fill Ones"  frame:(x:266 y:96 w:44 h:44)  icon:"icon.drop.gray.png"  value:(0...1=0)  -> sky.draw.screen.fillOne  } } }
        brush {
        ...
        scroll {
            ...
            controls {
                scrollOn { type:"panelon"  title:"Active"  frame:(x:168 y:6 w:48 h:32)  icon:"icon.scroll.png"  value:(0...1=0)
                    user -> scrollBox.value:(x:0.5 y:0.5)  { x y } lag:0  }
                hide { type:"panelx"  title:"hide"  frame:(x:0 y:0 w:40 h:40)  icon:"icon.thumb.X.png"  value:(0...1=0)  }
                scrollBox { type:"box"  title:"Screen Scroll"  frame:(x:86 y:48 w:128 h:128)  radius:10  tap2:(-1 -1)  lag:0  value:(x y):(0...1=0.5)  <-> sky.input.azimuth  -> sky.shader.drawScroll.buffer.scroll  user ->(brushTilt.value:0 accelTilt.value:0 scrollOn.value:1 )  }
                ...
                fillZero { type:"trigger"  title:"Fill Zero"  frame:(x:10 y:126 w:44 h:44)  icon:"icon.drop.clear.png"  value:(0...1=0)  -> sky.draw.screen.fillZero  } } }
        speed { restart -> speedOn:1  -> controls.speed.value:60
            base { type:"cell"  title:"Speed"  frame:(x:0 y:0 w:212 h:104)  icon:"icon.magnet.png"  }
            controls {
                speedOn { type:"panelon"  title:"Active"  frame:(x:154 y:6 w:48 h:32)  icon:"icon.scroll.png"  value:(0...1=0)  -> sky.main.run
                    user -> scrollBox.value:(x:0.5 y:0.5)  { x y } lag:0  }
                hide { type:"panelx"  title:"hide"  frame:(x:0 y:0 w:40 h:40)  icon:"icon.thumb.X.png"  value:(0...1=0)  }
    ...
    shader {
        ...
        tile {
            ...
            controls {
                ...
                repeatBox { type:"box"  title:"Repeat"  frame:(x:100 y:40 w:120 h:120)  radius:10  tap2:(-1 -1)  lag:0  user:(0...1=1)  -> tileOn.value:1  value:(0 0):(0...1)  -> sky.shader.render.buffer.repeat  } } } } }

...
kernel void cellCamix(texture2d<float, access::read>  inTex  [[ texture(0) ]],
    ...
    float4 mixItem = float4(
    outItem.r * version + inItem.r*(1.-version),
    outItem.g * version + inItem.g*(1.-version),
    outItem.b * version + inItem.b*(1.-version),
    outItem.a * version + inItem.a*(1.-version)
    );
